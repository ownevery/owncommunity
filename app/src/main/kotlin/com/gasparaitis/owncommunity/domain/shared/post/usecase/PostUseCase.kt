...
class PostUseCase {
    fun getHomePosts(): List<Post> = homePosts
    fun getTrendingPosts(): List<Post> = trendingPosts
    fun getLatestPosts(): List<Post> = latestPosts

    companion object {
        private val homePost1 = Post.EMPTY.copy(
        ...
        private val homePost2 = Post.EMPTY.copy(
            id = UUID.randomUUID().toString(),
        ...
        private val homePost3 = Post.EMPTY.copy(
            id = UUID.randomUUID().toString(),
            type = PostType.TextOnly,
        ...
        private val homePost4 = Post.EMPTY.copy(
            id = UUID.randomUUID().toString(),
            type = PostType.Images(images = listOf(R.drawable.demo_story_1)),
        ...
        private val homePosts = listOf(homePost1, homePost2, homePost3, homePost4)

        private val trendingPost1 = Post.EMPTY.copy(
            id = UUID.randomUUID().toString(),
            type = PostType.Images(images = listOf(R.drawable.demo_profile_14, R.drawable.demo_profile_15)),
            profileImage = R.drawable.demo_profile_picture_1,
        ...
        private val trendingPost2 = Post.EMPTY.copy(
            id = UUID.randomUUID().toString(),
            type = PostType.Images(images = listOf(R.drawable.demo_profile_12, R.drawable.demo_profile_13)),
            profileImage = R.drawable.demo_profile_picture_2,
        ...
        private val trendingPosts = listOf(trendingPost1, trendingPost2)

        private val latestPost1 = Post.EMPTY.copy(
            id = UUID.randomUUID().toString(),
            type = PostType.Images(images = listOf(R.drawable.demo_latest_1, R.drawable.demo_latest_2, R.drawable.demo_latest_3)),
            profileImage = R.drawable.demo_profile_picture_1,
        ...
        private val latestPost2 = Post.EMPTY.copy(
            id = UUID.randomUUID().toString(),
            type = PostType.TextOnly,
            profileImage = R.drawable.demo_profile_picture_2,
            authorName = "Jacob Washington",
        ...
        private val latestPost3 = Post.EMPTY.copy(
            id = UUID.randomUUID().toString(),
            type = PostType.Images(images = listOf(R.drawable.demo_profile_9)),
            profileImage = R.drawable.demo_profile_picture_3,
        ...
        private val latestPosts = listOf(latestPost1, latestPost2, latestPost3)
    }
}
